...
- 体験価値のある移動は積極的に探索する。ただし採用前に、時刻・所要時間、乗換・待ち、輪行負担、料金、時刻表拘束、後続行動を含む通常案をbaselineとして置く。優先して提案するなら、時間・料金差、失う行動、今回の区間で実際に得る体験を比較して示す。
- 1時間単位の時間差、重要な時間窓・当日の主役・宿到着・翌日の選択肢、または大きな追加料金に影響する差分は、暗黙にPrimeへ採用せず旅行者に選んでもらう。列車や路線全体の知名度・代表的景観を、今回の区間の体験価値の根拠にしない。
